 ...
 shinchan.velocityY = 0;
  ...
  if(gameState === "serve"){
   ...
   gameState = "play"; 
    ...
    if((touches.length>0 && mousePressedOver(SPACE)&& gameState === "serve")) {      
      serve();
      gameState = "play";
      shinchanS.play();
      touches = []
    ...
    if(mousePressedOver(R) && gameState === "end"){
      ...
      if((touches.length>0 && mousePressedOver(R))&& gameState === "end") {      
        shinchanS.stop();
        gameState = "serve";
        positionR();
        touches = []
  ...
  if((touches.length>0 && mousePressedOver(lArrow))&& gameState === "play") {      
    shinchan.velocityX= -5;
    touches = []
  }
  ...
  if((touches.length>0 && mousePressedOver(rArrow))&& gameState === "play") {      
    shinchan.velocityX= +5;
    touches = []
  }
  ...
  if((touches.length>0 && mousePressedOver(uArrow))&& gameState === "play") {      
    shinchan.velocityY= -5;
    touches = []
  }
  ...
  if((touches.length>0 && mousePressedOver(dArrow))&& gameState === "play") {      
    shinchan.velocityY= +5;
    touches = []
  }
